...
pcl::PointCloud<pcl::PointXYZ>::Ptr findBoundaryPointsImproved(const pcl::PointCloud<pcl::PointXYZ>::Ptr &cloud,
                                                               double radius = 0.013, double min_distance = 0.003) {
...
int main(int argc, char **argv) {
    ...
    pcl::io::savePLYFile("/home/rp/urop/test_ws/src/boundary_evaluation/src/boundary_gt/most_planer_cluster.ply", *most_planar_cluster);
    std::cout<<1;
    ...
    pcl::io::savePLYFile("/home/rp/urop/test_ws/src/boundary_evaluation/src/boundary_gt/projected_cloud.ply", *projected_cloud);
std::cout<<2;
    ...
    pcl::io::savePLYFile("/home/rp/urop/test_ws/src/boundary_evaluation/src/boundary_gt/boundary_points.ply", *boundary_pcd);
    std::cout<<3;
    ...
    pcl::io::savePLYFile("/home/rp/urop/test_ws/src/boundary_evaluation/src/boundary_gt/removed_line.ply", *noise_free_points);
